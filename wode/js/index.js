		...
		function e(t) {
			this.point = t || {
				...
				if(1 == v.way) {
					...
					e = e <= .05="" ?="" :="" e,="" e="e">= 1 ? 1 : e, this.point.y > 0 ? this.point.x + e <= this.r="" ?="" (this.point.x="" +="e," this.point.y="Math.sqrt(this.R" *="" -="" this.point.x="" this.point.x))="" :="" e="">= this.R * -1 ? (this.point.x -= e, this.point.y = Math.sqrt(this.R * this.R - this.point.x * this.point.x) * -1) : this.point.y *= -1
				}
